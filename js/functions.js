(function($) {
    "use strict";
    //----------> Site Preloader
    // var navBarElement = document.getElementById("navigation_bar");
    ...
    window.onload = function() {
        $("#wh-widget-send-button-wrapper").click();
    }
...
// 		document.querySelector(".top_expande").click();
// 	}
// });
$("#iframeMap").width($("#col-map").css('width'));
...
// 	var currentclassname = document.getElementById('navigation_bar-sticky-wrapper').className;
// 	if (currentclassname == "sticky-wrapper sticky_menu") {
// 		document.getElementById("indexpagebodyid").classList.remove('light_header');
// 		document.getElementById("indexpagebodyid").classList.add('dark_header');
// 		document.getElementById("indexpagebodyid").classList.add('dark_sup_menu');
// 	}
// 	else {		
// 		document.getElementById("indexpagebodyid").classList.remove('dark_header');
// 		document.getElementById("indexpagebodyid").classList.add('light_header');
// 		document.getElementById("indexpagebodyid").classList.remove('dark_sup_menu');
// 	}
// 	scrollPos = (document.body.getBoundingClientRect()).top;
// });

//  window.setInterval(function(){
// 	document.querySelector('.wh-widget-button-icon.wh-messenger-bg-activator').click();
//   }, 1000);

// var milliseconds = 0;
// milliseconds = setInterval(function () {
// 	if (document.querySelector(".wh-messenger-bg-activator") != null) {
// 		clearInterval(milliseconds);
// 		document.querySelector(".wh-messenger-bg-activator").click();
// 	}
// }, 500)


function languageChange(currlan) {
    if (sessionStorage.getItem('currentLanguage') != currlan) {
        var curractivepath = $('.normal_menu.mobile_menu_toggle.current_page_item a').attr('href');
        if (!curractivepath)
            curractivepath = $('#products-active a').attr('href');
        if (currlan == 'en') {
            newpath = curractivepath.replace('-ar', '');
        } else if (currlan == 'ar') {
            newpath = curractivepath.replace('-ar', '');
            newpath = curractivepath.replace('.html', '-ar.html');
        }
        window.location.replace(curractivepath.replace(curractivepath, newpath));
        // window.location.replace(curractivepath, newpath);

        sessionStorage.setItem('currentLanguage', currlan);
    }
}
var urlar = window.location.href;
urlar = urlar.indexOf("-ar.html");
if (!sessionStorage.getItem('currentLanguage')) {
    if (urlar > 0) {
        sessionStorage.setItem('currentLanguage', 'ar');
        languageChange('ar');
    } else {
...
if (sessionStorage.getItem('currentLanguage') == 'en') {
    document.getElementById('lanAr').style.color = '#fff';
    document.getElementById('lanEn').style.color = '#1ccdca';
} else {
    document.getElementById('lanEn').style.color = '#fff';
    document.getElementById('lanAr').style.color = '#1ccdca';
}